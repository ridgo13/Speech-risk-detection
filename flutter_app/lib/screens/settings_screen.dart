...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  bool _isWeeklyReminderEnabled = false;
  ...
  Future<void> _loadReminderStatus() async {
    Future<bool> Function() enabled = await _prefs.isWeeklyReminderEnabled;
    setState(() {
      _isWeeklyReminderEnabled = enabled as bool;
    });
  }
            ...
            child: Column(
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(color: AppColors.textTeal, fontSize: 16),
                ),
                ...
                _buildToggleCard(
                  title: "Weekly Health Reminder",
                  subtitle: "Receive weekly voice screening reminder.",
                  value: _isWeeklyReminderEnabled,
                  onChanged: (val) async {
                    setState(() => _isWeeklyReminderEnabled = val);
              ...
              children: [
                ...
                if (subtitle != null) ...[
                  ...
                  Text(
                    subtitle,
                    style: TextStyle(
                      color: AppColors.cardTextColor.withOpacity(0.7),
                      fontSize: 12,
                    ),
                  ),
                ],
  ...
  Widget _buildNavCard({required String title, required VoidCallback onTap}) {
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: isHighContrast.value
            ? []
            : [
                BoxShadow(
                  color: Colors.black.withOpacity(0.05),
