...
class AppColors {
  ...
  static Color get background =>
      isHighContrast.value ? _hcBackground : _standardBackground;
  static Color get mainTeal => isHighContrast.value ? _hcMain : _standardTeal;
  static Color get textTeal =>
      isHighContrast.value ? _hcText : _standardTextTeal;
  static Color get cardColor =>
      isHighContrast.value ? _hcBackground : _standardCard;
  static Color get cardTextColor =>
      isHighContrast.value ? _hcText : Colors.black;

  // Borders only appear in High Contrast mode
  static Color get borderColor =>
      isHighContrast.value ? _hcMain : Colors.transparent;
  static double get borderWidth => isHighContrast.value ? 2.0 : 0.0;

  static Color? get redColor => null;
}
