  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: AppColors
          .background, // Rule #1: Use dynamic background [cite: 40, 48]
      body: SafeArea(child: _buildCurrentBody()),
    );
  }
        ...
        Expanded(
          ...
          child: Column(
            ...
            children: [
              ...
              CustomPaint(
                ...
                child: Container(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      color:
                          AppColors.textTeal, // Rule #3: Text Teal [cite: 49]
              ...
              const SizedBox(
                height: 20,
              ), // Physical gap between bubble and face
              // AVATAR
              Expanded(
                child: Image.asset(
      ...
      child: Row(
        ...
        children: [
          ...
          IconButton(
            ...
            onPressed: () =>
                setState(() => isHighContrast.value = !isHighContrast.value),
          ),
        ],
      ),
    );
